...
# Generated by qmake (2.01a) (Qt 4.8.4) on: pe huhtikuuta 10 22:24:43 2015
# Project:  millenniumcoin-qt.pro
# Template: app
# Command: /home/jarkko/qt/4.8.4/bin/qmake USE_UPNP=- -o Makefile millenniumcoin-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DLINUX -DQT_GUI_LIB -DQT_CORE_LIB
CFLAGS        = -m64 -pipe -g -D_REENTRANT -Wall -W $(DEFINES)
CXXFLAGS      = -m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -g -D_REENTRANT -fdiagnostics-show-option -Wall -Wextra -Wno-ignored-qualifiers -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector $(DEFINES)
...
LINK          = g++
LFLAGS        = -m64 -fstack-protector-all --param ssp-buffer-size=1 -Wl,-rpath,/home/jarkko/qt/4.8.4/lib
...
SOURCES       = src/qt/bitcoin.cpp \
		...
		src/simd.c \
		src/skein.c \
		src/delegatemanager.cpp build/moc_bitcoingui.cpp \
...
Makefile: millenniumcoin-qt.pro  ../qt/4.8.4/mkspecs/linux-g++-64/qmake.conf ../qt/4.8.4/mkspecs/common/unix.conf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile millenniumcoin-qt.pro
...
build/delegatemanager.o: src/delegatemanager.cpp src/delegatemanager.h \
		src/net.h \
		src/mruset.h \
		src/netbase.h \
		src/serialize.h \
		...
		src/key.h \
		src/bignum.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/delegatemanager.o src/delegatemanager.cpp
